...
const displayPosts = post =>{
    ...
    post.forEach(postInfo => {
        ...
        postCard.classList= `w-full bg-grey flex`
        postCard.innerHTML= `
                ...
                <div class="w-[20%] ">
                    <div class="w-[70%] h-[60%] pl-8 relative">
                        ...
                        <div class="bg-white  rounded-full absolute w-[14px] h-[14px] top-0 right-0 ">
                            <div class="bg-green-700  rounded-full absolute w-3 h-3 top-0 right-0 "></div>
                        </div>
                ...
                <div class="w-[80%] text-[14px] text-[#12132D] bg-opacity-0.8 font-semibold">
                    ...
                    <div class="flex">
                        <div class="flex w-[90%] gap-10">
                            ...
                            <p class="">${postInfo.comment_count}</p>
                            </div>
                            ...
                            <div class="flex gap-4 items-center">
                                ...
                                <p class="">${postInfo.posted_time}</p>
